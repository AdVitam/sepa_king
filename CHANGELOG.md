...
- Architecture: `AttributeInitializer` concern, `SchemaValidation` concern, `Data.define` grouping value objects
- Extracted shared XML helpers to `Message` base class
